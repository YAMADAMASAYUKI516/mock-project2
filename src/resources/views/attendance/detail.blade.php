...
<div class="attendance-detail">
    ...
    <form
        action="{{ $attendance->id
            ...
            : route('attendance.request_by_date', $attendance->work_date) }}"
        method="POST">
        ...
        <table class="attendance-detail__table">
            ...
            {{-- 休憩1 --}}
            @if ($isEditable || $attendance->break1_start || $attendance->break1_end || $requestData?->break1_start || $requestData?->break1_end)
                <tr>
                    <th>休憩1</th>
            ...
            {{-- 休憩2 --}}
            @if ($isEditable || $attendance->break2_start || $attendance->break2_end || $requestData?->break2_start || $requestData?->break2_end)
                <tr>
                    <th>休憩2</th>
