...
<div class="admin-attendance-staff">
    ...
    <form method="GET" action="{{ route('admin.attendance.staff', $user->id) }}" class="admin-attendance-staff__month-form" id="monthForm">
        <a href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => $prevMonth]) }}" class="admin-attendance-staff__arrow-link">
        ...
        <a href="{{ route('admin.attendance.staff', ['id' => $user->id, 'month' => $nextMonth]) }}" class="admin-attendance-staff__arrow-link">
            <span class="admin-attendance-staff__arrow-text">翌月</span>
            <img src="{{ asset('images/arrow.png') }}" alt="翌月" class="admin-attendance-staff__arrow-icon admin-attendance-staff__arrow-icon--next">
        </a>
    </form>
...
<tbody>
    @foreach ($datesInMonth as $date)
        ...
        <tr>
            ...
            <td>
                ...
                @else
                    <a href="{{ route('admin.attendance.detail_by_date', ['user_id' => $user->id, 'date' => $dateKey]) }}">詳細</a>
                @endif
            </td>
        </tr>
    @endforeach
    ...
    <div class="admin-attendance-staff__export">
        <a
            href="{{ route('admin.attendance.export', ['id' => $user->id, 'month' => $currentMonth]) }}"
